    ...
    <div class="aa-slider-area"> 
      ...
      <div class="aa-top-slider">
        ...
        <div class="aa-top-slider-single">
          <img src="{{ asset('markups/img/slider/3.jpg') }}" alt="img">
          <!-- Top slider content -->
        ...
        <!-- Top slider single slide -->
        <div class="aa-top-slider-single">
          <img src="{{ asset('markups/img/slider/2.jpg') }}" alt="img">
          <!-- Top slider content -->
          <div class="aa-top-slider-content">
            <span class="aa-top-slider-catg">Duplex</span>
            <h2 class="aa-top-slider-title">1560 Square Feet</h2>
        ...
        <!-- Top slider single slide -->
        <div class="aa-top-slider-single">
          <img src="{{ asset('markups/img/slider/1.jpg') }}" alt="img">
          <!-- Top slider content -->
          <div class="aa-top-slider-content">
            <span class="aa-top-slider-catg">Duplex</span>
            <h2 class="aa-top-slider-title">1560 Square Feet</h2>
        ...
        <!-- / Top slider single slide -->       
         <!-- Top slider single slide -->
        <div class="aa-top-slider-single">
          <img src="{{ asset('markups/img/slider/5.jpg') }}" alt="img">
          <!-- Top slider content -->
          <div class="aa-top-slider-content">
            <span class="aa-top-slider-catg">Duplex</span>
            <h2 class="aa-top-slider-title">1560 Square Feet</h2>
        ...
        <!-- / Top slider single slide -->        
         <!-- Top slider single slide -->
        <div class="aa-top-slider-single">
          <img src="{{ asset('markups/img/slider/4.jpg') }}" alt="img">
          <!-- Top slider content -->
          <div class="aa-top-slider-content">
            <span class="aa-top-slider-catg">Duplex</span>
            <h2 class="aa-top-slider-title">1560 Square Feet</h2>
        ...
        <!-- / Top slider single slide -->
         <!-- Top slider single slide -->
        <div class="aa-top-slider-single">
          <img src="{{ asset('markups/img/slider/6.jpg') }}" alt="img">
          <!-- Top slider content -->
          <div class="aa-top-slider-content">
            <span class="aa-top-slider-catg">Duplex</span>
            <h2 class="aa-top-slider-title">1560 Square Feet</h2>
